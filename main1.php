...
<html>
    <head>
        <meta charset="utf-8">
        <title>Blog Aggeregator/Politics</title>
    ...
    <body>
        ...
        <div class ="center">
            ...
            // output RSS feed to HTML
               output_rss_feed('https://timesofindia.indiatimes.com/rssfeedstopstories.cms', 20, true, true, 200);
            ?>

            <?php
            // output RSS feed to HTML
               output_rss_feed('https://timesofindia.indiatimes.com/rssfeeds/1221656.cms', 20, true, true, 200);
            ?>
        </div>
